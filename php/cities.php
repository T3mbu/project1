<?php
    ...
    // Geonames API URL for cities within the bounding box
    $url = 'http://api.geonames.org/citiesJSON?north=' . $north . '&south=' . $south . '&east=' . $east . '&west=' . $west . '&username=tembuu';
    ...
    if (isset($decode['geonames']) && count($decode['geonames']) > 0) {
        ...
        // Handle no city data found
        $output['data'] = [];
        $output['status']['description'] = "No cities found for the provided region.";
    }
